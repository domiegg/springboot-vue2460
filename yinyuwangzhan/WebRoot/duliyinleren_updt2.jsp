...
-->
	...
	<body>
			<form action="updateDuliyinleren2.do" name="form1" method="post">
		...
		<tr ><td width="200">积分：</td><td><input name='jifen' type='text' id='jifen' value='' readonly="readonly" onblur='checkform()' style='border:solid 1px #000000; color:#666666' />&nbsp;*<label id='clabeljifen' /></td></tr>
