...
<div style="width:1200px; margin:0 auto;">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height="51">标题：</td>
		 <td width='39%'>${yinlexinxi.biaoti}</td><td width="65%"  rowspan=6 align=center><video src="${yinlexinxi.yinle}" width="300" height="200"  controls="controls"></video></td></tr><tr>
     <td width='11%' height="54">作者：</td>
     <td width='39%'>${yinlexinxi.zuozhe}</td></tr><tr>
     <td width='11%' height="76">分类标签：</td>
     <td width='39%'>${yinlexinxi.fenleibiaoqian}</td></tr><tr>
     <td width='11%' height="94">相关描述：</td>
     <td width='39%'>${yinlexinxi.xiangguanmiaoshu}</td>
     <td>&nbsp;</td><td>&nbsp;</td></tr><tr>							 
                                <td colspan="4"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("yinlexinxi",id)){
	pli=pli+1;
     %>
                                   <tr>
...
<input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('yinlexinxi','<%=id%>')"/>
<input type=button name=Submit52 value=收藏 onClick="javascript:location.href='jrsc.jsp?id=<%=id%>&biao=yinlexinxi&ziduan=biaoti';"  />
</td></tr>
  </table>
