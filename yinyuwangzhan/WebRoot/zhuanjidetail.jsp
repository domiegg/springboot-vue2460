...
<div style="width:1200px; margin:0 auto;">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height="60">专辑名：</td>
		 <td width='39%'>${zhuanji.zhuanjiming}</td><td width="65%"  rowspan=6 align=center><video src="${zhuanji.yinle}" width="300" height="200"  controls="controls"></video></td></tr><tr>
     <td width='11%' height="64">作者：</td>
     <td width='39%'>${zhuanji.zuozhe}</td></tr><tr>
     <td width='11%' height="56">发布日期：</td>
     <td width='39%'>${zhuanji.faburiqi}</td></tr><tr>
     <td width='11%' height="88">介绍：</td>
     <td width='39%'>${zhuanji.jieshao}</td>
     <td>&nbsp;</td><td>&nbsp;</td></tr><tr>							 
                                <td colspan="4"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("zhuanji",id)){
	pli=pli+1;
     %>
                                   <tr>
...
<input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('zhuanji','<%=id%>')"/>
<input type=button name=Submit52 value=收藏 onClick="javascript:location.href='jrsc.jsp?id=<%=id%>&biao=zhuanji&ziduan=zhuanjiming';"  />
</td></tr>
  </table>
