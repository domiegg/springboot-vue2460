...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateYinlexinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改音乐信息<input type="hidden" name="id" value="${yinlexinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.biaoti.value='${yinlexinxi.biaoti}';</script>	<script language="javascript">document.form1.yinle.value='${yinlexinxi.yinle}';</script>	<script language="javascript">document.form1.zuozhe.value='${yinlexinxi.zuozhe}';</script>	<script language="javascript">document.form1.fenleibiaoqian.value='${yinlexinxi.fenleibiaoqian}';</script>	<script language="javascript">document.form1.xiangguanmiaoshu.value='${yinlexinxi.xiangguanmiaoshu}';</script>	
					 </table>
			</form>
   </body>
</html>
